...
**Sempre** utilize os [tokens](?path=/docs/design-system-tokens-overview--docs) e [temas](?path=/docs/design-system-temas-overview--docs) definidos na configuração do Tamagui para manter a consistência visual.
