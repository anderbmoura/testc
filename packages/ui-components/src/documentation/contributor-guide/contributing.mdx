...
Este guia descreve o fluxo de trabalho para contribuir com a biblioteca React Native do DSC de forma organizada e eficiente.
...
Use mensagens de commit descritivas seguindo o padrão <a href="https://www.conventionalcommits.org/" target="_blank">Conventional Commits</a>, por exemplo:
